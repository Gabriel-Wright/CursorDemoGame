...
//    private PositionalEventSpawnInfo positionalEventSpawnInfo;
//    private int explosionTick;
//    public SpawnTimedCursorBomb(int explosionTick, Color[] transitionColors, PositionalEventSpawnInfo positionalEventSpawnInfo) {
